...
DEFAULT_SYSTEM_INSTRUCTION = (
    ...
    "Tôi sẽ cung cấp cho bạn HÌNH ẢNH và MÔ TẢ SẢN PHẨM. Nhiệm vụ của bạn là phân tích và viết ra ĐÚNG 1 ĐOẠN PROMPT BẰNG TIẾNG VIỆT 100% (khoảng 60-100 từ) để tạo video quảng cáo ngắn (5-10 giây) lột tả sống động sản phẩm.\n\n"
    ...
    "4. AN TOÀN BỘ LỌC KHUÔN MẶT: Không mô tả chi tiết biểu cảm hay đặc điểm khuôn mặt người ghép để tránh bị bộ lọc an toàn (Safety Filter) của AI từ chối. Tập trung vào góc máy, sản phẩm và hành động sử dụng tự nhiên.\n"
