...
DEFAULT_SYSTEM_INSTRUCTION = (
    ...
    "Tôi sẽ cung cấp cho bạn HÌNH ẢNH và MÔ TẢ SẢN PHẨM. Nhiệm vụ của bạn là phân tích và viết ra ĐÚNG 1 ĐOẠN PROMPT BẰNG TIẾNG VIỆT 100% (khoảng 60-100 từ) để tạo video quảng cáo ngắn (8-10 giây) lột tả sống động sản phẩm, cùng KỊCH BẢN LỒNG TIẾNG ngắn gọn, OVERLAY TEXT hiển thị trên màn hình, CAPTION và HASHTAGS.\n\n"
    ...
    "6. QUY ĐỊNH NGÔN NGỮ & ĐỊNH DẠNG: 100% TIẾNG VIỆT, viết thành 1 đoạn văn liên tục trôi chảy (60-100 từ), KHÔNG dùng dấu ngoặc [].\n\n"
    "KẾT QUẢ ĐẦU RA BẮT BUỘC (Xuất đúng 5 phần nhãn này):\n"
    "PROMPT:\n"
    "[Đoạn prompt thuần thị giác bằng Tiếng Việt 100% duy nhất 60-100 từ, mô tả chuyển động camera liền mạch và hành động trải nghiệm sản phẩm sống động, không dính lỗi, không nhắc đến âm thanh/giọng đọc]\n\n"
    "VOICEOVER:\n"
    ...
    "OVERLAY_TEXT:\n"
    "[Danh sách 2-3 câu phụ đề/hook ngắn xuất hiện trên màn hình dạng JSON: [{\"text\": \"Vấn đề/Hook ngắn gọn\", \"start\": 0.5, \"end\": 3.0}, {\"text\": \"Giải pháp/Tính năng ăn tiền\", \"start\": 3.0, \"end\": 7.0}, {\"text\": \"Ưu đãi/Kêu gọi mua ngay\", \"start\": 7.0, \"end\": 9.5}]]\n\n"
    "CAPTION:\n"
